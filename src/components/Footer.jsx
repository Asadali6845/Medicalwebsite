...
const Footer = () => {
  return (
    <div className=" bg-green-400  text-white rounded-t-3xl mt-8 md:mt-0">
      <div className="flex flex-col md:flex-row justify-between p-8 md:px-32 px-5">
        <div className="w-full md:w-1/4">
          <h1 className="font-semibold text-x1 pb-4">WellnessVista</h1>
          <p className="text-sm">
    ...
    <div>
        <h1 className="font-medium text-x1 pb-4 pt-5 md:pt-0">Services</h1>
        <nav className="flex flex-col gap-2">
        <Link
            to="services"
            spy={true}
    ...
    <div className="w-full md:w-1/4">
    <h1 className="font-medium text-x1 pb-4 md:pt-0">Contact Us</h1>
    <nav className="flex flex-col gap-2">
